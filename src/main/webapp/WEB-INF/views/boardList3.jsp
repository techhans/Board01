    ...
    <table>
      ...
      <c:forEach var="boardDto" items="${list}">
        <tr>
          ...
          <td class="title"><a href="<c:url value="/board/read${ph.sc.queryString}&bno=${boardDto.bno}&replyCnt=${boardDto.comment_cnt}"/>">${boardDto.title}</a> (${boardDto.comment_cnt})</td>
